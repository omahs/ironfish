...
//   }
//   const checksumCfg = {
//     headers: { range: `bytes=${startByte}-${endByte}`, check_sum: 1 },
//   }

//   const checkSum: { data: IncomingMessage } = await axios.get(url, checksumCfg)
...
//         } catch (e) {} // remove invalid file
//         onError &&
//           onError(
//             { message: `Checksum mismatch. Expect: ${checkSum}, Received: ${result.checksum}` },
//             i,
//           )
//       }
//     } catch (e) {
//       try {
//         fs.unlinkSync(filePath)
//       } catch (e) {} // remove invalid file if exist
//       onError && onError(e, i)
//     }
//   }
